<?php
    ...
    class Dao_user_model extends CI_Model{
		...
		public function m_load_data_person(){
			...
			p.N_LAST_NAME AS apellido, p.D_START_DAY AS dia_de_inicio, 
		...
		public function update_person(){
			...
			$this->db->where('K_ID_POSITION', $data2['K_ID_POSITION']);
			$this->db->update('position', $data2);
			$this->db->where('K_ID_PROJECT', $data2['K_ID_PROJECT']);
